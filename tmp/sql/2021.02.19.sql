...
CREATE TABLE `api_point_history` (
                                     ...
                                     `stamp` int(10) UNSIGNED NOT NULL,
                                     `from_user_point_before` int(11) NOT NULL,
                                     `from_user_point_apply` int(11) NOT NULL,
                                     `from_user_point_after` int(11) NOT NULL,
                                     `to_user_point_before` int(11) NOT NULL,
...
ALTER TABLE `api_point_history`
    ADD PRIMARY KEY (`ID`),
  ADD KEY `from_user_ID_stamp_reason` (`from_user_ID`,`stamp`,`reason`),
